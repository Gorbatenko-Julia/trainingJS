...
function testArray(a, b) {
    let array=(a+b).split('');//создаём массив из a b 
   array.unshift('Иванов');//первый элемент теперь Иванов
   return array.reverse().join('');//переворачиваем массив и объединяем элементы в строку 
